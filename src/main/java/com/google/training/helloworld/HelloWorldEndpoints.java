...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="greetByAge", path = "greetByAge", 
    		httpMethod = HttpMethod.GET)
    
    public HelloClass greetByAge (@Named("name") String name, @Named("period") String period , @Named("age") String age){
    	return new HelloClass(name, period, age);
    }
}
